...
class Learner(object):
    ...
    def act(self, snake, food):
        ...
        if rand < self.epsilon:
            ...
            #[0] is used to extract the first (and only) element from this list.
        else:
    ...
    def _GetState(self, snake, food):
        ...
        if dist_y > 0: #lw el msafa been el food w head akber mn 0 y3ni 
        ...
        for sq in sqs:
            if sq[0] < 0 or sq[1] < 0: # off screen left or top
                ...
                surrounding_list.append('1')
            elif sq in snake[:-1]: # part of tail   ":-1 " a5er element fel array
                surrounding_list.append('1')
            else:
                surrounding_list.append('0') # y3ni hwaleh fady aw el morb3 da safe ano yt7rk leh
